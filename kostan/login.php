...
<div id="skip-menu"></div>
	...
	<div id="content">
		...
		<div id="column-1">
			...
			<!-- Middle column -->
		<div class="login">
	<form action="proseslogin.php" method="post" align="center">
     <table align="center">
         ...
         <tr><center><td colspan="2" align="right"><input value="Login" type="submit"> <input value="Batal" type="reset"></td></center></tr>
         <tr><center><td colspan="2" align="center">Belum Punya akun ? <a href="daftar.php"><b>Daftar</b></a></td></center></tr>
     </table>
   </form>
	</div>
			<!-- Middle column end -->
